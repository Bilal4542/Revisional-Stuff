  ...
  return (
    <div className='flex items-center justify-between bg-gray-200 p-2 mb-2 mt-4 rounded'>
      ...
      <div className="flex items-center gap-4 text-xl">
        <button ><MdOutlineDone className='text-green-600 cursor-pointer hover:scale-105' /></button>
        <button><MdDelete className='text-red-600 cursor-pointer hover:scale-105'/></button>
      </div>
    </div>
  )
}
